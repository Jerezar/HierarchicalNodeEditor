...
bool FHNE_MultiConnectionBuilder::RegisterValuePin(UEdGraphPin* InPin, UObject* InObject)
{
    ...
    return (*Tracker)->RegisterValuePin(InPin, InObject);
}

bool FHNE_MultiConnectionBuilder::RegisterArrayPins(TArray<UEdGraphPin*> InPins, FArrayProperty* InProperty, UObject* InObject)
{
    ...
    UE_LOG(LogTemp, Log, TEXT("Found matching tracker"));
    return (*Tracker)->RegisterArrayPins(OutputPins, InProperty, InObject);
}
